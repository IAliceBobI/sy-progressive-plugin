...
export class TomatoI18n extends TomatoI18nABC {
    ...
    public get AI轮数上限() {
        switch (this.lang) {
            case "zh_CN": return "单次提问最多工具轮数（默认 4）";
            case "zh_CHT": return "單次提問最多工具輪數（默認 4）";
            case "es_ES": return "Máximo de rondas de herramientas por pregunta (por defecto 4)";
            case "fr_FR": return "Nombre maximal de tours d'outils par question (4 par défaut)";
            case "ja_JP": return "1 回の質問あたりの最大ツール実行回数（デフォルト 4）";
            case "en_US":
            default: return "Max tool turns per question (default 4)";
        }
    }
    public get AI人审说明() {
        switch (this.lang) {
