...
<!-- delswap □1 删片换书（650189 鸟反馈）：换书双箭头（iconProgSwap 同源 ⇄ 压缩进左上）
     + ban 圆底角标（delBack/delExit 家族同款 r5.5 圆底右下角） -->
<symbol id="iconProgDelSwap" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M2 5h9"/><path d="m8 2 3 3-3 3"/><path d="M13 12H4"/><path d="m7 9-3 3 3 3"/><circle cx="17" cy="17" r="5.5"/><path d="m14.8 14.8 4.4 4.4"/><path d="m19.2 14.8-4.4 4.4"/></symbol>
