...
function loadStore(plugin: BaseTomatoPlugin) {
    ...
    // □5 progfix0922：分片自动制卡独立开关（默认开）——漏 load 同坑静默无效
    pieceAutoCard.load(plugin);
    ...
    floatbarFlatManifest.load(plugin);
